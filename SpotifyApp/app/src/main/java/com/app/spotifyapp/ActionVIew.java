...
//
//    private static final String CLIENT_ID = "6aae9f0166d0413c9061c523559d173e";
//    private static final String REDIRECT_URI = "com.app.spotifyapp://callback";
//
//    private static final String TRACK_URI = "spotify:track:4Li2WHPkuyCdtmokzW2007";
//    private static final String ALBUM_URI = "spotify:album:20r762YmB5HeofjMCiPMLv";
//    private static final String ARTIST_URI = "spotify:artist:5K4W6rqBFWDnAN6FQUkS6x";
//    private static final String PLAYLIST_URI = "spotify:playlist:37i9dQZF1DWVA1Gq4XHa6U";
...
//    AppCompatSeekBar _binding.seekToBar;
...
//                        _binding.seekToBar.setMax((int) playerState.track.duration);
//                        mTrackProgressBar.setDuration(playerState.track.duration);
//                        mTrackProgressBar.update(playerState.playbackPosition);
//                    }
//
//                    _binding.seekToBar.setEnabled(true);
//                }
//            };
//
//    @Override
...
//
//        _binding.seekToBar = findViewById(R.id.seek_to);
//        _binding.seekToBar.setEnabled(false);
//        _binding.seekToBar.getProgressDrawable().setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_ATOP);
//        _binding.seekToBar.getIndeterminateDrawable().setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_ATOP);
//
//        mTrackProgressBar = new TrackProgressBar(_binding.seekToBar);
//
//        mViews =
//                Arrays.asList(
...
//                        ActionVIew.this.onConnected();
//                    }
//
//                    @Override
//                    public void onFailure(Throwable error) {
//                        logError(error);
//                        ActionVIew.this.onDisconnected();
//                    }
//                });
//    }
//
...
//        if (view.getTag() != null) {
//            String albumURI = JsonParser.parseString(gson.toJson(view.getTag()))
//                .getAsJsonObject()
...
//                .getAsString();
//
////            String a = gson.toJson(view.getTag());
//            System.out.println(albumURI);
//            Log.d("ALBUM XXXXXXXXXXXX", albumURI);
//
//            showDialog("PlayerState", gson.toJson(view.getTag()));
////            JsonParser parser = new JsonParser();
////            JsonElement element = parser.parse(jsonString);
////
////            JsonObject playerState = element.getAsJsonObject();
////            JsonObject track = playerState.getAsJsonObject("track");
////            JsonObject album = track.getAsJsonObject("album");
////
////            String albumUri = album.get("uri").getAsString();
////            System.out.println(albumUri); // prints "spotify:album:2P2Xwvh2xWXIZ1OWY9S905"
//
//        }
//    }
//
